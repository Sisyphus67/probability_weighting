...
{\normalsize A mechanistic model for probability weighting\thanks{The code to generate the figures is available at \href{https://bit.ly/lml-pw-code}{bit.ly/lml-pw-code}.
...
%\author{Ole Peters\thanks{London Mathematical Laboratory and Santa Fe Institute,~\protect\url{o.peters@lml.org.uk}}\and Alexander Adamou\thanks{London Mathematical Laboratory,~\protect\url{a.adamou@lml.org.uk}}\and Mark Kirstein\thanks{London Mathematical Laboratory, Max-Planck-Institute for Mathematics in the Sciences, Leipzig and Institute of Mathematics, Leipzig University,~\protect\url{m.kirstein@lml.org.uk}}\and Yonatan Berman\thanks{London Mathematical Laboratory,~\protect\url{y.berman@lml.org.uk}}}
