...
\documentclass[12pt,letter,timesnewroman]{article}

\usepackage{amsthm, amsmath, amssymb, mathrsfs, multirow, url}
\usepackage{amsfonts} 
\usepackage[noblocks,auth-sc-lg]{authblk}
...
% AUTHORS WITH EMAIL+AFFIL IN A FOOTNOTE EACH
...
Yonatan Berman\thanks{London Mathematical Laboratory and Stone Center on Socio-Economic Inquality at City University New York, \texttt{\href{mailto:y.berman@lml.org.uk}{\Letter~y.berman@lml.org.uk}}}
\hfill
}

% AUTHORS WITH AFFIL BLOCK and EMAILS IN A SINGLE FOOTNOTE
% \author[1,2]{Ole Peters}
% \author[1]{Alexander Adamou}
% \author[1,3,4]{Mark Kirstein}
% \author[1]{Yonatan Berman%
% \thanks{
% \texttt{
% \href{mailto:o.peters@lml.org.uk}{\Letter~o.peters@lml.org.uk}
% \href{mailto:a.adamou@lml.org.uk}{~\Letter~a.adamou@lml.org.uk}
% \href{mailto:m.kirstein@lml.org.uk}{~\Letter~m.kirstein@lml.org.uk}
% \href{mailto:y.berman@lml.org.uk}{~\Letter~y.berman@lml.org.uk}
% }}
% }

% AUTHORS WITH AFFIL BLOCK and EMAILS IN A FOOTNOTE EACH
...
% SHORT VERSIONS OF THE AFFILIATIONS
...
% LONGER VERSIONS OF THE AFFILIATIONS
...
% \\
% \noindent\textbf{Keywords:}~ Probability Weighting, Ergodicity Economics
% \\
% \noindent\textbf{JEL Codes:} C61, D01, D81\\
\bigskip
\end{abstract}
\end{titlepage}
