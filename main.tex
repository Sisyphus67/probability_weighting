...
%An additional apparent distortion of probabilities has been reported as early as in \textcite[Fig. 1, p. 188]{PrestonBaratta1948}, 
to introduce psychological distortions not of wealth but of probabilities.
% \textquote{psychological probabilities} as a function of mathematical probabilities to reconcile experimental data with EVT.
...
%The mechanism we propose can generate mismatches between probabilities and decision weights which produce a variety of probability weighting curves, including the standard inverse-S curve (see \fref{mapping_cdfs}).
