...
\caption{Probability weighting for $t$-distributions, where the DM uses a different shape parameter (1) and a different location parameter (0.35) from those of the DO (3 and 0.2, respectively).}
...
Formalising these thoughts, we find that so long as relative uncertainties are larger for rare events than for common events (which, generically, they are), an inverse-S curve emerges. 
