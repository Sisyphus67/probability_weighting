...
wrote that people's concern about a potential coronavirus outbreak in the US was attributable to an extreme case of probability weighting: people were neglecting the fact that such an event had a low probability. When the piece was published, many disagreed: it seemed reasonable to them to take precautions; Sunstein himself, they said, might have underestimated both the severity and likelihood of a pandemic. They asked the \textcite{Cohen1979a} question: ``Whose is the fallacy?''
