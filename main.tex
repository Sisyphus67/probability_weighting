...
\ee
for small bin width, $\delta x \ll 1$. Repeating this procedure across the domain of the density function, i.e. for all possible events, gives a decision weight density of
\be
...
\Fref{square_root_error} shows the resulting PDFs and the CDF mappings, for a Gaussian distribution and for a fat-tailed Student-t distribution for $T=100$ observations. As one might expect, the effect is more pronounced for the fat-tailed distribution.
\begin{figure}[htb]
\centering
