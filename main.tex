...
Some have interpreted probability weighting as a cognitive bias that leads to errors of judgement and to poor decisions by DMs\footnote{
...
Put simply, prospect theory is an attempt to model systematic errors in human decision making, arising (in part) from inappropriate psychological adjustments of known probabilities.}.
...
We are by no means the first to raise this question. Commenting on another so-called cognitive bias regarding probabilities (the representativeness fallacy), \citet{Cohen1979a} asked: ``Whose is the fallacy?''
...
%\citet{Gigerenzer2018} pointed out that 
%simply avoiding probabilities altogether often resolves apparent disagreements between DO and DM.
