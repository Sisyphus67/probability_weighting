...
Empirical patterns in behavioural economics such as the inverse-S are typically presented as a cognitive bias.\footnote{\MK{Add supporting references}}
% 
Here, we propose a mechanistic explanation for probability weighting (PW) as rational behaviour which arises from a difference in the uncertainty models of the DO and DM. 

% Ecological/Adaptive Rationality 
More generally, our results fall into line with work on ecological rationality or adaptive rationality 
\footcite{Smith2003a,GigerenzerSelten2002b,Todd2012} and the evolutionary origin of dynamically consistent preferences \footcite{Robson1996,RobattoSzentes2017,SarverSadowski2019}.

% Decision from Description-Experience-Gap
Understanding that the inference problems of the DM and the DO are distinct and involve different uncertainties also helps to understand the description-experience gap \footcite{HertwigETAL2004,HertwigErev2009,ErevETAL2010,WulffETAL2018}. Here, the time perspective formalises the DM's general inference problem according to his experience of a sequence of events.
%  Decision sampling
Similar inference problems of the DM have also been studied under the heading of (Bayesian) decision sampling \footcite{Stewart2006,Martins2006,GalesicETAL2012,SeoETAL2019}.

% Behavioural ecology studies ? 
\MK{Studies on optimal foraging in behavioural ecology show \ldots \footnote{Ask Kacelnik!} \ldots}

Therefore, we identify an emerging consensus in the literature spread over several lines of research to understand PW and similar empirical regularities as rational behaviour once the ecological circumstances and cognitive limitations of the DM are taken properly into account \footcite{Gigerenzer1991,LiederETAL2018}. Furthermore, using the time perspective our results provide a generalisation of all these findings into the coherent framework of ergodicity economics.
