...
\Fref{square_root_error} shows the resulting probability and weights densities and CDF mappings generated by setting $\phat(x)$ in \eref{weight_density_spec} to be the density functions of a Gaussian distribution and a fat-tailed $t$-distribution. Inverse-S curves are found for both distributions and the effect is more pronounced for the fat-tailed distribution.
\begin{figure}[!htb]
\centering
