...
axes[0].plot(x, DO, 'r', lineWidth='3', label=r'$F_{p,0,1}(x)$')
axes[0].plot(x, DM, 'b', lineWidth='3', label=r'$F_{w,0,3}(x)$')
...
axes[1].plot(DO, DM, 'm', lineWidth='3', label=r'$w(p)$')
