...
#axes[0].plot(xx, wp4, color='m', lineWidth='2', label=r"$F_w= F_p^{\gamma} / ( F_p^{\gamma} + (1-F_p)^{\gamma})^{(1/\gamma)}$")
...
#axes[1].plot(xx, wp4, color='m', lineWidth='2', label=r"$F_w= F_p^{\gamma} / ( F_p^{\gamma} + (1-F_p)^{\gamma})^{(1/\gamma)}$")
