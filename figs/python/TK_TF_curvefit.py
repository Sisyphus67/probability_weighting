...
axes[0].plot(xx, wp1, 'b', lineWidth='2', label=r'$\tilde{F}_{TK}=\delta F_p^{\gamma} / (\delta F_p^{\gamma} + (1-F_p)^{\gamma})$')
axes[0].plot(xx, wp2, 'r', lineWidth='2', label=r'Gaussian model')
axes[0].plot(xx, wp3, color='0.5', lineWidth='2', label=r"t model")
axes[0].plot(xx, wp4, color='m', lineWidth='2', label=r"$\tilde{F}_{L} = F_p^{\gamma} / ( F_p^{\gamma} + (1-F_p)^{\gamma})^{(1/\gamma)}$")
...
axes[1].plot(xx, wp1, 'b', lineWidth='2', label=r'$\tilde{F}_{TK}=\delta F_p^{\gamma} / (\delta F_p^{\gamma} + (1-F_p)^{\gamma})$')
axes[1].plot(xx, wp2, 'r', lineWidth='2', label=r'Gaussian model')
axes[1].plot(xx, wp3, color='0.5', lineWidth='2', label=r"t model")
axes[1].plot(xx, wp4, color='m', lineWidth='2', label=r"$\tilde{F}_{L} = F_p^{\gamma} / ( F_p^{\gamma} + (1-F_p)^{\gamma})^{(1/\gamma)}$")
