# -*- coding: utf-8 -*-
"""
Created on Tue Jun 16 12:37:21 2020
...
axes[1].plot(DO, DM_loc_scale, 'b', lineWidth='2',label=r'$F_w(F_p)$')
axes[1].set_title('Ergodicity Economics', fontsize='x-large')
...
beta = 0.65
axes[0].plot(DO, DO, 'r', lineWidth='2', label=r'$F_p$')
axes[0].axvline(x=0.5, LineStyle='--')
axes[0].plot(DO, s(DO, beta), 'b', lineWidth='2', label=r'$F_w$')
axes[0].set_title('Tversky and Kahneman (1992)', fontsize='x-large')
...
fig.savefig("./../KT_vs_Our_result_LocScale.pdf", bbox_inches='tight')
plt.show()