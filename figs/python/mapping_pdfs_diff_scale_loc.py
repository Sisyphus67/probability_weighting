# -*- coding: utf-8 -*-
"""
Created on Thu Jun 11 08:35:17 2020
...
# for slides title are good
axes[0].set_title('Different Scale and Location')
...
# for slides title are good
axes[1].set_title('Different Scale and Location')
